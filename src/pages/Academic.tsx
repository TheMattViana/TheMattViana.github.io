...
import { academicProjects } from '../data/academicData';
        ...
        <Layout variant="cream">
            <div className="bg-charcoal min-h-screen p-8 md:p-20 pt-32">
                <section className="max-w-4xl mx-auto">
                    <div className="flex justify-between items-end mb-8 border-b border-gold-antique/20 pb-4">
                        <h2 className="font-serif text-3xl md:text-4xl text-gold-antique">Academic Research</h2>
                        <div className="flex space-x-4">
                            <a href="/writing_sample.pdf" target="_blank" className="text-cream/70 hover:text-gold-antique text-sm border border-gold-antique/30 px-3 py-1 rounded hover:bg-gold-antique/10 transition-colors">Writing Sample</a>
                            <a href="https://scholar.google.com/citations?user=V5sYiqIAAAAJ&hl=en" target="_blank" className="text-cream/70 hover:text-gold-antique text-sm border border-gold-antique/30 px-3 py-1 rounded hover:bg-gold-antique/10 transition-colors">Google Scholar</a>
                        </div>
                    </div>
