    ...
    return (
        <div className="bg-charcoal min-h-screen pt-28 pb-20 px-4 flex flex-col items-center relative">
            ...
            <div className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-40">
                <button className="flex items-center space-x-3 bg-gold-antique text-[#1a1a1a] font-serif font-bold py-4 px-8 rounded-full shadow-[0_0_20px_rgba(212,175,55,0.4)] hover:bg-cream hover:scale-105 transition-all duration-300">
                    <Download size={22} />
